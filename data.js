// ============================================================
//  data.js — Ojash Desk  |  Owner: Ojash Singh  |  OjashSingh
...
const CUSTOMERS_DATA = [
  { id: 'c1',  name: 'John Doe',       email: 'john.doe@email.com',      company: 'Acme Corp',     plan: 'Pro',        location: 'New York, USA',    phone: '+1 (555) 123-4567', since: 'Jan 15, 2023', orders: 12, lifetime: '$1,245.00', avatar: 'av-blue',   initials: 'JD', csat: 4.8, tickets: 5  },
  { id: 'c2',  name: 'Sarah Mitchell', email: 'sarah.m@techcorp.com',     company: 'TechCorp',      plan: 'Enterprise', location: 'London, UK',        phone: '+44 7700 900123',   since: 'Mar 3, 2023',  orders: 8,  lifetime: '$3,420.00', avatar: 'av-pink',   initials: 'SM', csat: 4.5, tickets: 8  },
  { id: 'c3',  name: 'Robert Williams',email: 'robert.w@startup.io',      company: 'StartupIO',     plan: 'Pro',        location: 'Austin, TX',        phone: '+1 (512) 987-6543', since: 'Feb 20, 2023', orders: 3,  lifetime: '$780.00',   avatar: 'av-orange', initials: 'RW', csat: 3.9, tickets: 3  },
  { id: 'c4',  name: 'Olivia Lee',     email: 'olivia.lee@design.co',     company: 'DesignCo',      plan: 'Free',       location: 'San Francisco, CA', phone: '+1 (415) 234-5678', since: 'Apr 10, 2023', orders: 1,  lifetime: '$0.00',     avatar: 'av-green',  initials: 'OL', csat: 5.0, tickets: 1  },
  { id: 'c5',  name: 'David Brown',    email: 'david.b@enterprise.com',   company: 'Enterprise Ltd',plan: 'Enterprise', location: 'Chicago, IL',       phone: '+1 (312) 345-6789', since: 'Dec 1, 2022',  orders: 22, lifetime: '$8,900.00', avatar: 'av-purple', initials: 'DB', csat: 4.2, tickets: 12 },
  { id: 'c6',  name: 'Ana Cortez',     email: 'ana.c@devhouse.com',       company: 'DevHouse',      plan: 'Pro',        location: 'Miami, FL',         phone: '+1 (305) 456-7890', since: 'Jun 5, 2023',  orders: 6,  lifetime: '$1,560.00', avatar: 'av-teal',   initials: 'AC', csat: 4.7, tickets: 4  },
  { id: 'c7',  name: 'Mark Klein',     email: 'mark.k@solutions.net',     company: 'Solutions.net', plan: 'Pro',        location: 'Seattle, WA',       phone: '+1 (206) 567-8901', since: 'Jul 19, 2023', orders: 9,  lifetime: '$2,100.00', avatar: 'av-red',    initials: 'MK', csat: 4.1, tickets: 6  },
  { id: 'c8',  name: 'Lena Torres',    email: 'lena.t@mediagroup.com',    company: 'MediaGroup',    plan: 'Free',       location: 'Boston, MA',        phone: '+1 (617) 678-9012', since: 'Aug 8, 2023',  orders: 0,  lifetime: '$0.00',     avatar: 'av-yellow', initials: 'LT', csat: 0,   tickets: 2  },
  { id: 'c9',  name: 'Chris Park',     email: 'chris.p@cloudpro.io',      company: 'CloudPro',      plan: 'Enterprise', location: 'Los Angeles, CA',   phone: '+1 (213) 789-0123', since: 'Sep 14, 2023', orders: 18, lifetime: '$5,600.00', avatar: 'av-blue',   initials: 'CP', csat: 4.9, tickets: 9  },
  { id: 'c10', name: 'Nina Patel',     email: 'nina.p@innovate.co',       company: 'Innovate Co',   plan: 'Pro',        location: 'Toronto, CA',       phone: '+1 (416) 890-1234', since: 'Oct 22, 2023', orders: 4,  lifetime: '$920.00',   avatar: 'av-pink',   initials: 'NP', csat: 4.3, tickets: 3  },
];

// ─── TICKETS ─────────────────────────────────────────────────
const TICKETS_DATA = [
  {
    id: 'TK-1024', subject: 'Unable to login to account', customer: 'John Doe', customerId: 'c1',
    email: 'john.doe@email.com', status: 'open', priority: 'High', category: 'Account',
    ...
    messages: [
      { from: 'customer', name: 'John Doe',    initials: 'JD', avatar: 'av-blue',   time: '2m ago',        text: "I'm unable to login to my account. I tried resetting my password but didn't receive any email." },
      { from: 'agent',    name: 'Ojash Singh', initials: 'OS', avatar: 'av-purple', time: '1m ago (Edited)', text: "Hi John,\n\nI'm sorry you're facing this issue. Let me help you with that.\nCould you please confirm the email associated with your account?" },
      { from: 'customer', name: 'John Doe',    initials: 'JD', avatar: 'av-blue',   time: 'Just now',      text: "Yes, it's john.doe@email.com" },
    ],
    activity: [
  ...
  {
    id: 'TK-1023', subject: 'Payment failed but amount deducted', customer: 'Sarah Mitchell', customerId: 'c2',
    email: 'sarah.m@techcorp.com', status: 'open', priority: 'Medium', category: 'Billing',
    assignee: 'Priya Sharma', assigneeId: 'a2', sla: '5h left', updated: '15m ago',
    created: '2026-06-24T08:45:00', channel: 'email',
    tags: ['Billing', 'Payment'],
    messages: [
      { from: 'customer', name: 'Sarah Mitchell', initials: 'SM', avatar: 'av-pink', time: '15m ago', text: 'My payment failed but I can see the amount has been deducted from my bank account. Please help urgently!' },
      { from: 'agent',    name: 'Priya Sharma',   initials: 'PS', avatar: 'av-blue', time: '10m ago', text: 'Hi Sarah, I completely understand your concern. Let me check this with our billing team right away. Could you please share the transaction ID from your bank statement?' },
    ],
  ...
  {
    id: 'TK-1022', subject: 'Refund not received after 7 days', customer: 'Robert Williams', customerId: 'c3',
    email: 'robert.w@startup.io', status: 'pending', priority: 'Medium', category: 'Billing',
    assignee: 'Rohan Mehta', assigneeId: 'a3', sla: 'Breached', updated: '1h ago',
    created: '2026-06-23T10:00:00', channel: 'web',
    tags: ['Refund', 'Billing'],
    messages: [
      { from: 'customer', name: 'Robert Williams', initials: 'RW', avatar: 'av-orange', time: '1h ago', text: "I requested a refund 7 days ago but haven't received it yet. Order #ORD-8821." },
    ],
  ...
  {
    id: 'TK-1021', subject: 'Feature request: Dark mode', customer: 'Olivia Lee', customerId: 'c4',
    email: 'olivia.lee@design.co', status: 'open', priority: 'Low', category: 'Feature Request',
    assignee: 'Ojash Singh', assigneeId: 'a1', sla: '48h left', updated: '3h ago',
    created: '2026-06-24T06:00:00', channel: 'web',
    tags: ['Feature Request', 'UI'],
    messages: [
      { from: 'customer', name: 'Olivia Lee', initials: 'OL', avatar: 'av-green', time: '3h ago', text: 'Would love to see a dark mode option in the app! My eyes would thank you. 😊' },
      { from: 'agent',    name: 'Ojash Singh', initials: 'OS', avatar: 'av-purple', time: '2h ago', text: "Hi Olivia! Great suggestion — dark mode is actually on our roadmap for Q3. I've added your vote to the feature request. Thanks for the feedback!" },
    ],
  ...
  {
    id: 'TK-1020', subject: 'How to update billing information?', customer: 'David Brown', customerId: 'c5',
    email: 'david.b@enterprise.com', status: 'open', priority: 'Medium', category: 'Billing',
    assignee: 'Priya Sharma', assigneeId: 'a2', sla: '6h left', updated: '5h ago',
    created: '2026-06-24T04:00:00', channel: 'email',
    tags: ['Billing', 'Account'],
    messages: [
      { from: 'customer', name: 'David Brown', initials: 'DB', avatar: 'av-purple', time: '5h ago', text: "I need to update my credit card on file. Can't figure out where to do it in the settings." },
    ],
    activity: [],
    internalNotes: [],
  ...
  {
    id: 'TK-1019', subject: 'API rate limit issue', customer: 'Ana Cortez', customerId: 'c6',
    email: 'ana.c@devhouse.com', status: 'resolved', priority: 'High', category: 'Technical Issue',
    assignee: 'Rohan Mehta', assigneeId: 'a3', sla: 'Met', updated: '1d ago',
    created: '2026-06-23T09:00:00', channel: 'web',
    tags: ['API', 'Technical'],
    messages: [
      { from: 'customer', name: 'Ana Cortez', initials: 'AC', avatar: 'av-teal', time: '1d ago', text: 'Getting 429 Too Many Requests errors on the /api/v2/tickets endpoint.' },
      { from: 'agent',    name: 'Rohan Mehta', initials: 'RM', avatar: 'av-green', time: '1d ago', text: 'Hi Ana! Your account was hitting the 100 req/min limit. I have increased it to 500 req/min for your Enterprise plan. The change is live now.' },
      { from: 'customer', name: 'Ana Cortez', initials: 'AC', avatar: 'av-teal', time: '23h ago', text: 'Perfect, working now! Thank you so much.' },
    ],
  ...
  {
    id: 'TK-1018', subject: "Can't export reports", customer: 'Mark Klein', customerId: 'c7',
    email: 'mark.k@solutions.net', status: 'resolved', priority: 'Medium', category: 'Technical Issue',
    assignee: 'Ojash Singh', assigneeId: 'a1', sla: 'Met', updated: '1d ago',
    created: '2026-06-23T07:00:00', channel: 'chat',
    tags: ['Reports', 'Export'],
    messages: [
      { from: 'customer', name: 'Mark Klein', initials: 'MK', avatar: 'av-red', time: '1d ago', text: 'The export to CSV button does nothing when I click it.' },
      { from: 'agent',    name: 'Ojash Singh', initials: 'OS', avatar: 'av-purple', time: '1d ago', text: "Hi Mark! This was a known bug with Chrome 124. We pushed a fix — please clear your cache with Ctrl+Shift+R and try again." },
    ],
  ...
  {
    id: 'TK-1017', subject: 'Need to add team members', customer: 'Lena Torres', customerId: 'c8',
    email: 'lena.t@mediagroup.com', status: 'closed', priority: 'Low', category: 'Account',
    assignee: 'Priya Sharma', assigneeId: 'a2', sla: 'Met', updated: '2d ago',
    created: '2026-06-22T10:00:00', channel: 'email',
    tags: ['Account', 'Team'],
    messages: [
      { from: 'customer', name: 'Lena Torres', initials: 'LT', avatar: 'av-yellow', time: '2d ago', text: 'How do I invite team members to my account? I checked Settings but cannot find it.' },
      { from: 'agent',    name: 'Priya Sharma', initials: 'PS', avatar: 'av-blue', time: '2d ago', text: "Hi Lena! Go to Settings > Agents > Invite Agent. You can add up to 5 agents on the Free plan." },
    ],
  ...
  {
    id: 'TK-1016', subject: 'SAML SSO configuration help', customer: 'Chris Park', customerId: 'c9',
    email: 'chris.p@cloudpro.io', status: 'pending', priority: 'Urgent', category: 'Technical Issue',
    ...
    messages: [
      { from: 'customer', name: 'Chris Park', initials: 'CP', avatar: 'av-blue', time: '3h ago', text: 'We are trying to configure SAML SSO with our Okta instance and getting an ACS URL mismatch error.' },
    ],
    activity: [],
    internalNotes: [
  ...
  {
    id: 'TK-1015', subject: 'Invoice download not working', customer: 'Nina Patel', customerId: 'c10',
    email: 'nina.p@innovate.co', status: 'open', priority: 'Medium', category: 'Billing',
    assignee: 'Rohan Mehta', assigneeId: 'a3', sla: '8h left', updated: '6h ago',
    created: '2026-06-24T03:00:00', channel: 'web',
    tags: ['Billing', 'Invoice'],
    messages: [
      { from: 'customer', name: 'Nina Patel', initials: 'NP', avatar: 'av-pink', time: '6h ago', text: 'I cannot download my invoice from May 2026. The download button shows a 404 error.' },
    ],
    activity: [],
    internalNotes: [],
...
const CHAT_SESSIONS = [
  { id: 'ch1', customer: 'John Doe',       initials: 'JD', avatar: 'av-blue',   email: 'john.doe@email.com',    location: 'New York, USA', status: 'active',  lastMsg: "Yes, it's john.doe@email.com",          time: 'Just now', unread: 1, totalTickets: 5 },
  ...
  { id: 'ch3', customer: 'Tom Walker',     initials: 'TW', avatar: 'av-green',  email: 'tom.w@walker.io',       location: 'Sydney, AU',     status: 'waiting', lastMsg: 'How do I export data?',                  time: '5m',       unread: 0, totalTickets: 1 },
  { id: 'ch4', customer: 'Emma Stone',     initials: 'ES', avatar: 'av-orange', email: 'emma.s@stone.com',      location: 'Paris, France',  status: 'active',  lastMsg: 'Thanks! That worked perfectly.',         time: '8m',       unread: 0, totalTickets: 3 },
  { id: 'ch5', customer: 'Alex Nguyen',    initials: 'AN', avatar: 'av-teal',   email: 'alex.n@nguyen.co',      location: 'Singapore',      status: 'idle',    lastMsg: 'Still waiting for a response...',        time: '15m',      unread: 0, totalTickets: 0 },
  { id: 'ch6', customer: 'Zara Ahmed',     initials: 'ZA', avatar: 'av-purple', email: 'zara.a@ahmed.net',      location: 'Dubai, UAE',     status: 'closed',  lastMsg: 'Issue resolved. Thank you so much!',    time: '1h',       unread: 0, totalTickets: 4 },
];

// ─── CHAT MESSAGES (Live Chat) ────────────────────────────────
const CHAT_MESSAGES_DATA = {
  ch1: [
    { from: 'customer', name: 'John Doe',    initials: 'JD', avatar: 'av-blue',   time: '09:12', text: "Hi, I'm unable to login to my account. I tried resetting my password but didn't receive any email." },
    { from: 'agent',    name: 'Ojash Singh', initials: 'OS', avatar: 'av-purple', time: '09:13', text: "Hi John! I'm sorry to hear that. Let me check your account right away. Could you confirm the email address you're using?" },
    { from: 'customer', name: 'John Doe',    initials: 'JD', avatar: 'av-blue',   time: '09:14', text: "Yes, it's john.doe@email.com" },
  ],
  ch2: [
  ...
  ch3: [
    { from: 'customer', name: 'Tom Walker', initials: 'TW', avatar: 'av-green', time: '09:07', text: 'How do I export my data from the analytics page?' },
  ],
  ch4: [
    { from: 'customer', name: 'Emma Stone', initials: 'ES', avatar: 'av-orange', time: '09:00', text: 'The issue with the API rate limit is fixed now!' },
    { from: 'agent',    name: 'Ojash Singh', initials: 'OS', avatar: 'av-purple', time: '09:01', text: "That's great to hear, Emma! Happy to help. 😊" },
    { from: 'customer', name: 'Emma Stone', initials: 'ES', avatar: 'av-orange', time: '09:04', text: 'Thanks! That worked perfectly.' },
  ],
  ch5: [
    { from: 'customer', name: 'Alex Nguyen', initials: 'AN', avatar: 'av-teal', time: '08:50', text: 'Is anyone there? Still waiting for a response...' },
  ],
  ch6: [
    { from: 'customer', name: 'Zara Ahmed', initials: 'ZA', avatar: 'av-purple', time: '08:30', text: 'Issue resolved. Thank you so much!' },
...
const NOTIFICATIONS_DATA = [
  ...
  { id: 'n3', text: 'Sarah Mitchell replied to #TK-1023',      time: '15m ago', read: false },
  { id: 'n4', text: 'Chris Park opened a new urgent ticket',   time: '1h ago',  read: true  },
...
const PORTAL_TICKETS = [
  { id: 'TK-1024', subject: 'Unable to login to account', status: 'open',    priority: 'High',   category: 'Account',          updated: '2m ago',  messages: [
    { from: 'customer', name: 'John Doe', initials: 'JD', avatar: 'av-blue', time: '2m ago', text: "I'm unable to login. Password reset email not received." },
  ...
  { id: 'TK-1021', subject: 'Feature request: Dark mode', status: 'open',    priority: 'Low',    category: 'Feature Request',  updated: '3h ago',  messages: [
    { from: 'customer', name: 'John Doe', initials: 'JD', avatar: 'av-blue', time: '3h ago', text: 'Would love a dark mode option!' },
  ...
  { id: 'TK-1018', subject: "Can't export reports", status: 'resolved', priority: 'Medium', category: 'Technical Issue', updated: '1d ago', messages: [
    { from: 'customer', name: 'John Doe', initials: 'JD', avatar: 'av-blue', time: '1d ago', text: 'Export button not working.' },
  ...
  { id: 'TK-1015', subject: 'Invoice download not working', status: 'pending', priority: 'Medium', category: 'Billing', updated: '6h ago', messages: [
    { from: 'customer', name: 'John Doe', initials: 'JD', avatar: 'av-blue', time: '6h ago', text: 'Cannot download May 2026 invoice. Getting 404.' },
  ]},
];

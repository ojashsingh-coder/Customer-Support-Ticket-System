// ============================================================
//  features.js — Ojash Desk  |  Owner: Ojash Singh  |  OjashSingh
//  Advanced features: Live Chat, Canned Responses, SLA engine,
//  CSAT, Multi-channel, Team Collaboration, AI Copilot.
// ============================================================
...
function handleCannedTrigger(el) {
  ...
  const matches = window.OD.CANNED_RESPONSES.filter(cr =>
    cr.shortcode.toLowerCase().includes('/' + query) || cr.title.toLowerCase().includes(query)
  );
